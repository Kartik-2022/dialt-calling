...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 py-8">
      {/* Modal content container */}
      <div className="bg-white rounded-lg shadow-lg max-w-lg w-full p-6 relative mx-4 max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose} // This calls the onClose prop (which is 'toggle' from AddEntryModal)
